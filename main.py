...
if userdata == False:
   print("sorry no data found")
    ...
    if amount > 10000 or amount < 0:
        print("sorry the amount is too much you can deosit below 10000 and above o")
    else:
       print(userdata)
...
def updatedetails(self):
    ...
    if userdata == False:
       ...
       print("you cannit change the age, account number, balance")

       print("Fill the details for change or leave it empty if no change") 

    newdata = {
       "name" : input("please tell new or press enter: "),
